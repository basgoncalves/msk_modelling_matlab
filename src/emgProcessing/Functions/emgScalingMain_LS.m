...
% Sampling rate if collected directly through Nexus
emgSamplingRate = 1000;
% Sampling rate if collected using Noraxon software (e.g., data stored in
% ASCII
emgSamplingRateASCII = 1500;
...
%     nameRoot = contentMaxDir(s).name(1:end-5);
    ...
    save([sessionData, filesep, nameRoot, [nameRoot, '_emgMetrics.mat']], 'subjectEmgMetrics');
