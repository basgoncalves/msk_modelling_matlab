...
try
    ...
    disp('No field runIK exists in selections structure')
end
...
try
    ...
    disp('No field plotIK exists in selections structure')
end
...
try
    ...
    disp('No field runMA exists in selections structure')
end
...
try
    ...
    disp('No field plotMA exists in selections structure')
end
...
try
    ...
    disp('No field runID exists in selections structure')
end    
...
try
    ...
    disp('No field plotID exists in selections structure')
end
...
try
    ...
    disp('No field runSO exists in selections structure')
end
