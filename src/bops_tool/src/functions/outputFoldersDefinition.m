...
switch tag
    ...
    case 'MA'
     ...
     case 'KA'
        ...
        outputDir=[inputDir(1:ind) 'kinematicsAnalysis' filesep elaborationID filesep];
        
    case 'RRA'
        
        outputDir=[inputDir(1:ind) 'residualReductionAnalysis' filesep elaborationID filesep];
    otherwise
