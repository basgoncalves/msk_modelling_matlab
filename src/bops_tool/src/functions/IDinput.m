function [fcut_coordinates, inputTrials, IKresultsDir, varargout] = IDinput(trialsList, varargin)
...
if nargout>1
    ...
    if nargin
     ...
     if nargout == 4   %Get folder with Inverse Kinematics results to use for ID
         
         IKresultsDir = uigetdir(varargin{1}, 'Select folder with INVERSE KINEMATICS results to use');
     end
end
