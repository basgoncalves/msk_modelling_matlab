function [FullFileName, RelativeFilePath] = inputFilesListGeneration_BG(inputDir, trialsList, tag)
...
%                               if strcmp(FileName{k}(i).name(end-9:end),'Assist.mot')==1
                              if strcmp(FileName{k}(i).name,'Assist.mot')==1
                                   continue
                              elseif strcmp(FileName{k}(i).name,'IK.mot')==1
                                  nFile=i;
                                  break
                              else
                                   nFile=i;
