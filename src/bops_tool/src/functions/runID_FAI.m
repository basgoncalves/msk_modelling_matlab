function []=runID_FAI(osimModel, coordinates_file, GRFmot_file, genericExtLoadFullPath, results_directory, lowpassfcut, varargin)
...
%External Load File
AcqDir = [fileparts(fileparts(fileparts(fileparts(GRFmot_file)))) filesep 'acquisition.xml'];
[~ , CurrentTrial] = fileparts(fileparts(GRFmot_file));
externForcesTree = writeGRFxml (AcqDir,genericExtLoadFullPath,CurrentTrial);
