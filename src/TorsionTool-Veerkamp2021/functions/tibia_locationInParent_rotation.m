...
if strcmp(answerLeg, rightbone) == 1;
    talus_old = str2num(dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,5}.Joint.CustomJoint.location_in_parent.Text);
    calcn_old = str2num(dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,6}.Joint.CustomJoint.location_in_parent.Text);
    toes_old = str2num(dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,7}.Joint.CustomJoint.location_in_parent.Text);
else
    talus_old = str2num(dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,10}.Joint.CustomJoint.location_in_parent.Text);
    calcn_old = str2num(dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,11}.Joint.CustomJoint.location_in_parent.Text);
    toes_old = str2num(dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,12}.Joint.CustomJoint.location_in_parent.Text);
end
...
if strcmp(answerLeg, rightbone) == 1;
    dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,5}.Joint.CustomJoint.location_in_parent.Text = num2str(locationTalusRot);
else
...
%Find the joint axis
if strcmp(answerLeg, rightbone) == 1;
    Axis_Ankle = str2num(dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,5}.Joint.CustomJoint.SpatialTransform.TransformAxis{1,1}.axis.Text);
else
    Axis_Ankle = str2num(dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,10}.Joint.CustomJoint.SpatialTransform.TransformAxis{1,1}.axis.Text);
end
...
if strcmp(answerLeg, rightbone) == 1;
    dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,5}.Joint.CustomJoint...
        .SpatialTransform.TransformAxis{1,1}.axis.Text = num2str(Axis_Ankle_rot_trans);
else
...
if strcmp(answerLeg, rightbone) == 1;
    dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,6}.Joint.CustomJoint.location_in_parent.Text = num2str(locationCalcn_transform);
else
    dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,11}.Joint.CustomJoint.location_in_parent.Text = num2str(locationCalcn_transform);
end
%Location of the calcn axis
if strcmp(answerLeg, rightbone) == 1;
    Calcn_subtalar = str2num(dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,6}.Joint.CustomJoint.SpatialTransform.TransformAxis{1,1}.axis.Text);
else
    Calcn_subtalar = str2num(dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,11}.Joint.CustomJoint.SpatialTransform.TransformAxis{1,1}.axis.Text);
end
% convert the the joint axis to the matlab coordinate system
...
if strcmp(answerLeg, rightbone) == 1;
    dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,6}.Joint.CustomJoint.SpatialTransform.TransformAxis{1,1}.axis.Text = num2str(Calcn_subtalar_rot_trans);
else
    dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,11}.Joint.CustomJoint.SpatialTransform.TransformAxis{1,1}.axis.Text =num2str(Calcn_subtalar_rot_trans);
end
...
if strcmp(answerLeg, rightbone) == 1;
    dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,7}.Joint.CustomJoint...
        .location_in_parent.Text = num2str(locationToes_transform);  
else
    dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,12}.Joint.CustomJoint...
        .location_in_parent.Text = num2str(locationToes_transform);
end
...
if strcmp(answerLeg, rightbone) == 1;
    toes_mtp =str2num(dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,7}.Joint...
        .CustomJoint.SpatialTransform.TransformAxis{1,1}.axis.Text);
else
    toes_mtp =str2num(dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,12}...
        .Joint.CustomJoint.SpatialTransform.TransformAxis{1,1}.axis.Text);
end
% convert the the joint axis to the matlab coordinate system
...
if strcmp(answerLeg, rightbone) == 1;
    dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,7}.Joint...
        .CustomJoint.SpatialTransform.TransformAxis{1,1}.axis.Text = num2str(toes_mtp_rot_trans);
else
    dataModel.OpenSimDocument.Model.BodySet.objects.Body{1,12}.Joint...
        .CustomJoint.SpatialTransform.TransformAxis{1,1}.axis.Text = num2str(toes_mtp_rot_trans);
end
