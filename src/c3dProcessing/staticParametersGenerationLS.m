...
function staticParameters = staticParametersGenerationLS(staticSettings,acquisitionInfo,foldersPaths,varargin)
...
try
    ...
    markerstoDelete = {'RMT23', 'LMT23', 'RWRR', 'RWRU', 'LWRR', 'LWRU'};
    trcMarkersList =  regexprep(trcMarkersList, markerstoDelete', '');
    trcMarkersList = trcMarkersList(~cellfun('isempty',trcMarkersList));
