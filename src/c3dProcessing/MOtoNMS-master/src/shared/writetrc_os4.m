function []= writetrc_os4(markers,MLabels,VideoFrameRate,FullFileName)   
...
% 
% Basilio Goncalves, basilio.goncalves7@gmail.com
% Updated to OpenSim 4 format
% 
...
fprintf(fid, '%g\t%g\t%d\t%d\t%s\t%g\t%d\t%d\n',VideoFrameRate, VideoFrameRate, nFrames, nMarkers, 'mm', VideoFrameRate, DataStartFrame,nFrames);
