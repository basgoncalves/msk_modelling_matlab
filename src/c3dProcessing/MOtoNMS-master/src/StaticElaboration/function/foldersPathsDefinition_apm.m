function [foldersPaths]=foldersPathsDefinition_apm (inputPath,trialName,configFilePath)
%
...
if nargin>0
    ...
    [fileName,inputFilePath] = uigetfile([filesep '*.c3d'],'Select .c3d input file for static elaboration');
...
%Session Data folder
sessionDataFolder=[ElaboratedDataPath filesep 'sessionData' filesep];

matDataPath=[sessionDataFolder trialName ];


staticElaborationsPath=[ElaboratedDataPath filesep 'staticElaborations' filesep];
...
%     IDstaticElaboration = cell2mat(inputdlg('Insert New Elaboration Identifier'));
    ...
    IDstaticElaboration = 'StaticCal';
    
    elaborationPath=[staticElaborationsPath filesep trialName filesep IDstaticElaboration filesep];
