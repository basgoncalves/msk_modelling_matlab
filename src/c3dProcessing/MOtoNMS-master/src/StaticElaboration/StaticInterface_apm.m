...
function []=StaticInterface_apm(trialName, InputDataPath)
...
while newElaboration==1 
    ...
    if strcmp(choice,'Run Static Elaboration')==0
        ...
        %Folders Definitions
        foldersPaths=foldersPathsDefinition(InputDataPath, trialName);
    ...
    switch choice
        ...
        case 'Run Static Elaboration'
            ...
            runStaticElaboration_apm(staticElaborationFilePath, foldersPaths, parameters);
    ...
    if staticElaborationFile==1
        ...
        if strcmp(choice2,'Run Static Elaborations')
            for ne=1:e
                runStaticElaboration_apm(elaborationPaths{ne},foldersPaths);
            end
        end
