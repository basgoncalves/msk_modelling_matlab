...
function []=runDataProcessing_TG(ElaborationFilePath,fc_EMG)
...
[MarkersRawData, MarkersLabels, Frames]=loadMatData((foldersPath.sessionData), trialsList, 'Markers'); % Parenthesis added
