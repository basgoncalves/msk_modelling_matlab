...
INPUTS.outputFilePath = [baseDir '\results_SO_Pen100_AVA_p30\'] ; % full path for SO & JRA outputs
...
INPUTS.overrideWeights = [100] ; % A column vector the same size as weights  
