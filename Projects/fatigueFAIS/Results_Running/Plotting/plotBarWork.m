...
function plotBarWork (NormalizedWork,stdWork,AvgVelocityMax,StdVelocityMax,TitleName,YLabel)
figure
...
Pre(2).FaceColor = (convertRGB ([7, 162, 245]));
Pre(3).FaceColor = (convertRGB ([158, 38, 38]));
...
Post(2).FaceColor = (convertRGB ([7, 162, 245]));
Post(3).FaceColor = (convertRGB ([158, 38, 38]));
...
set(ax.YAxis, 'Color', 'k')
 ...
 %% Legend and axis
lh = legend([Pre(1) Post(1) Post(2) Post(3) VelPlot(1) Eb(1)],...
    'Pre fatigue trials', 'Hip joint work','Knee joint work','Ankle joint work',...
