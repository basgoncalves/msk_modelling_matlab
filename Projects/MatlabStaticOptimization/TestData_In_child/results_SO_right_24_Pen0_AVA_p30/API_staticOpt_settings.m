...
<<<<<<<< HEAD:Projects/MatlabStaticOptimization/TestData/results_SO_left_4_Pen100_AVA_p0/API_staticOpt_settings.m
...
for iPen = Penalties
    ...
    for i = 4:length(contacts_leftLeg)-1
        ...
        currentfile=strcat(FileNameAndLocation, '.m');
        copyfile(currentfile,newbackup);
>>>>>>>> main:Projects/MatlabStaticOptimization/TestData_In_child/results_SO_right_24_Pen0_AVA_p30/API_staticOpt_settings.m
    end
